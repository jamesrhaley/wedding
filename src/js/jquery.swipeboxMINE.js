		...
		ui = {
			...
			showBars : function () {
				...
				if ( this.doCssTrans() ) {
					...
					// console.log( "show",this.doCssTrans() );
					bars.addClass( 'visible-bars' );
				} else {
			...
			hideBars : function () {
				var bars = $( '#swipebox-top-bar, #swipebox-bottom-bar' );
				if ( this.doCssTrans() ) {
					// console.log( "hide",this.doCssTrans() );
			...
			getVideo : function( url ) {
				...
				return ['<div class="swipebox-video-container" style="max-width:', plugin.settings.videomaxWidth, 'px"><div class="swipebox-video">', iframe, '</div></div>'].join("");
			},
